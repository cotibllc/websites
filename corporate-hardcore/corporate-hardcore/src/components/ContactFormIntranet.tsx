...
export default function ContactFormIntranet({ subjectOptions }: Props) {
  ...
  if (status === "success") {
    return (
      <div className="border border-synergy-green bg-synergy-green-light p-4" role="status">
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      {status === "error" && (
        <p className="font-mono text-[11px] text-red-600">
          ...
          <a href="mailto:hello@corphardcore.com" className="underline">hello@corphardcore.com</a>.
        </p>
      )}
